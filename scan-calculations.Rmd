...
st_write(flood_archive, "data-sharing/03-analysis-inputs/flood-events/flood-events.shp")
```
...
ggsave("plots/ngdc-earthquake-events.pdf", device = "pdf",
       width = 20, height = 5.833, units = "in", dpi = "print")
st_write(eq_near, "data-sharing/03-analysis-inputs/earthquakes/earthquakes-1000km.shp")
