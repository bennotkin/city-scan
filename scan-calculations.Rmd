...
eq_text <- eq_near %>%
  ...
  mutate(
    ...
    text2 = paste(line1, line2, line3, line4, sep = "; "),
...
eq_plot <-
  ...
  geom_text_repel(
    data = \(x) slice_max(x, magXdist, n = 10), aes(label = text2), size = 4,
  ...
  theme(axis.line = element_line(linewidth = .5, color = "black"),
        legend.position = "bottom",
        plot.margin = margin(5.5, 450, 5.5, 5.5, "pt"),
