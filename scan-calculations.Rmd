...
## Urban Flooding
```{r}
flood_osm_file <- list.files("Stats", full.names = T) %>% str_subset("flood_osm")
if (length(flood_osm_file) == 1) {
  ...
  if (length(flood_osm_file) > 1) {
    warning("Too many files in Stats/ match flood_osm pattern")
  }
}
flood_road_file <- list.files("Stats", full.names = T) %>% str_subset("flood_road")
if (length(flood_road_file) == 1) {
  ...
  if (length(flood_road_file) > 1) {
    warning("Too many files in Stats/ match flood_road pattern")
  }
}
...
flood_file <- str_subset(list.files("Stats", full.names = T), "flood_wsf.csv")
...
flood_pop_file <- list.files("Stats", full.names = T) %>% str_subset("flood_pop")
if (length(flood_road_file) == 1) {
  ...
  if (length(flood_pop_file) > 1) {
    warning("Too many files in Stats/ match flood_pop pattern")
  }
}
