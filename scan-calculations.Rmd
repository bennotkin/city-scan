...
if (in_oxford) {
  ...
  if (nrow(pop_growth) == 0) {
    ...
    pop_growth <- read_csv("manual-data-entry/pop.csv", col_types = "c") %>%
...
# Density from citypopulation.de
...
# Density from manual data entry file
density_manual <- read_csv("manual-data-entry/density.csv", col_types = "ccdcd") 
